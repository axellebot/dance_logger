...
abstract class VideoRepository extends EntityRepository<VideoEntity> {
  FutureOr<List<VideoEntity>> getListOfSearch(String search, {
  ...
  FutureOr<List<VideoEntity>> getVideosOfArtist(String artistId, {
  ...
  FutureOr<List<VideoEntity>> getVideosOfFigure(String figureId, {
    required Offset offset,
